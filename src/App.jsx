...
const FD="'Cormorant Garamond','Playfair Display',Georgia,serif";
...
const RECIPES=[
  ...
  {id:20,name:"Veal Scaloppine with Lemon",category:"Meat",cookTime:25,calories:390,fat:18,protein:42,carbs:12,serves:"2",planAhead:false,perishable:[],ingredients:["veal","egg","flour","butter","olive oil","lemon"],directions:["Pound veal thin between waxed paper with a mallet.","Dip veal in egg then dredge in flour seasoned with salt and pepper.","Brown veal on all sides in oil and half the butter.","Remove veal to a warm plate.","Add remaining butter to skillet. When bubbling, add lemon juice.","Pour sauce over veal. Garnish with lemon slices and parsley. Serve immediately."],note:"Very quick. ~20 min total.",image:""},
  {id:21,name:"Scaloppine al Marsala",category:"Meat",cookTime:20,calories:370,fat:16,protein:38,carbs:10,serves:"2",planAhead:false,perishable:[],ingredients:["veal scaloppine","flour","butter","olive oil","marsala wine"],directions:["Sprinkle veal with salt and pepper. Coat lightly in flour on both sides.","Heat butter and oil in a skillet until hot and almost smoking.","Add veal and cook quickly until golden brown on one side. Turn and cook other side.","Transfer meat to a heated plate.","Add Marsala to skillet and cook, stirring, to dissolve pan drippings.","Reduce wine slightly and pour over meat."],note:"Very quick. ~15 min total.",image:""},
